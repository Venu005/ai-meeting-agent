  ...
  return (
    <div className='app-gradient-bg flex min-h-dvh'>
      <div className='relative hidden w-1/2 flex-col justify-between overflow-hidden bg-sidebar p-10 text-sidebar-foreground lg:flex'>
        <div className='absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,oklch(0.627_0.104_181.5/0.3),transparent_60%)]' />
        ...
        <p className='text-sidebar-foreground/50 relative text-xs'>© {new Date().getFullYear()} Meetra</p>
      </div>
      ...
      <div className='flex flex-1 flex-col items-center justify-center px-6 py-12'>
        <div className='w-full max-w-sm space-y-8'>
          ...
          <Button
            ...
            className='hover:border-primary/50 h-12 w-full transition-colors duration-200'
          >
