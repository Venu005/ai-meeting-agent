...
How to look up current documentation from https://mastra.ai when local packages aren't available or you need conceptual
guidance.
...
**Critical feature**: Send the `text-markdown` request header or add `.md` to any documentation URL to get clean,
